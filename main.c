...
void listar_produtos(Produto lista[], int total) {
    ...
    for (int i = 0; i < total; i++) {
        // BUG corrigido : esqueceram de imprimir o ID e a quebra de linha está inadequada 
    
       printf("ID: %d | Codigo: %s | Nome: %s | Preco: R$ %.2f | Qtd: %d\n",
...
int main(void) {
    ...
    //inicialização do codigo de barras para os produtos
    estoque[0].id = 1;
